...
#!/bin/bash
# ============================================================
# MASTER BASIC INSTALLER — NO OLLAMA
# ============================================================
# This installer:
...
#   - DOES NOT pull any models
#   - DOES NOT install Docker or Enterprise stack
#
# This is the “lightweight” version for users who only want
# your Pi Edition UI/backend installed.
# ============================================================
...
echo -e "${YELLOW}"
echo "============================================================"
echo "      MASTER BASIC INSTALLER — NO OLLAMA (SAFE MODE)"
echo "============================================================"
echo -e "${NC}"
...
# ------------------------------------------------------------
echo -e "${YELLOW}============================================================"
echo " BASIC INSTALL (NO OLLAMA) COMPLETE"
echo "============================================================${NC}"

echo -e "${GREEN}Your UI/backend is installed at:${NC}"
echo "$MOUNT_POINT/stack/openwebui"

echo -e "${GREEN}This version installs ONLY the UI/backend."
echo "You can add Ollama or Docker later using the upgrade installers.${NC}"
```
