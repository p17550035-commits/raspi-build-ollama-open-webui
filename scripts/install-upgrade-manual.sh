...
#!/bin/bash
# ============================================================
# MASTER UPGRADE INSTALLER — MANUAL STACK (WITH DRIVE SAFETY)
# ============================================================
# This installer:
#   - Uses the drive‑safe skeleton
#   - Prepares external drive safely
#   - Creates full enterprise folder structure
#   - Sets up the Pi for manual (non‑Docker) upgrades
#   - Prepares directories for future manual tarball installs
#
# NOTE:
...
#
#   It ONLY prepares the Pi + external drive for your future
#   manual upgrade tarballs (Postgres, Redis, Qdrant, MinIO,
#   Gitea, OpenWebUI backend, etc.)
# ============================================================
...
echo -e "${YELLOW}"
echo "============================================================"
echo "   MASTER UPGRADE INSTALLER — MANUAL STACK (SAFE MODE)"
echo "============================================================"
echo -e "${NC}"
...
# ------------------------------------------------------------
# STEP 7 — Prepare manual upgrade environment
# ------------------------------------------------------------
echo -e "${GREEN}Preparing manual upgrade environment...${NC}"
...
echo -e "${GREEN}Manual upgrade environment ready.${NC}"
echo ""

# ------------------------------------------------------------
# STEP 8 — Placeholder for future manual tarball installs
# ------------------------------------------------------------
echo -e "${YELLOW}============================================================"
echo "Manual upgrade environment prepared."
echo "============================================================${NC}"

echo -e "${GREEN}This installer is ready for your future MANUAL tarballs."
echo "When you create your manual upgrade tarballs later,"
...
# ------------------------------------------------------------
echo -e "${YELLOW}============================================================"
echo " MANUAL UPGRADE INSTALLER COMPLETE"
echo "============================================================${NC}"

echo -e "${GREEN}Your manual upgrade environment is ready at:${NC}"
